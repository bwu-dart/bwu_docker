library bwu_docker.src.v1x20.data_structures;
...
class CommitResponse {
  ...
  CommitResponse.fromJson(Map<String, dynamic> json, Version apiVersion) {
    ...
    checkSurplusItems(
        apiVersion,
        {
          RemoteApiVersion.v1x20: const ['Id', 'Warnings']
        },
        json.keys);
  }
}
...
class ContainerInfo {
  ...
  List<String> _mounts;
  List<String> get mounts => new UnmodifiableListView<String>(_mounts);
  ...
  ContainerInfo.fromJson(Map<String, dynamic> json, Version apiVersion) {
    ...
    _mounts = json['Mounts'] as List<String>;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (mounts != null) json['Mounts'] = mounts;
...
class HostConfig {
  ...
  // TODO(zoechi) find actual type (String is just a guess)
  String _groupAdd;
  ...
  // TODO(zoechi) find actual type (String is just a guess)
  String _memorySwappiness;
  String get memorySwappiness => _memorySwappiness;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (groupAdd != null) json['GroupAdd'] = groupAdd;
